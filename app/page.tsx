        ...
        <div className="max-w-6xl mx-auto">
          ...
          <nav className="grid grid-cols-2 md:grid-cols-5 gap-4 max-w-5xl mx-auto" aria-label="サービスナビゲーション">
            ...
            >
              ...
              <h3 className="font-semibold text-base text-gray-900 group-hover:text-purple-600 transition-colors">ワークショップ</h3>
            ...
            >
              <div className="text-2xl mb-2">🏢</div>
              <h3 className="font-semibold text-base text-gray-900 group-hover:text-purple-600 transition-colors">出張・研修</h3>
              <p className="text-xs text-gray-500 mt-1">法人・団体向け</p>
            </Link>
            <Link
              href="/partner"
              className="p-5 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow text-center group"
            >
              <div className="text-2xl mb-2">🤝</div>
              <h3 className="font-semibold text-base text-gray-900 group-hover:text-purple-600 transition-colors">導入プラン</h3>
