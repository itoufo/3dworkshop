...
export const metadata: Metadata = {
  ...
  description: "東京都文京区湯島のAI×3Dプリンタ教室。自由創作クラスをご用意。有料版AIが使い放題、ワークショップ30％OFF、作品発表会参加券など特典多数。入会月は月謝無料。湯島駅徒歩1分。",
  ...
  openGraph: {
    title: "スクール・教室 | AI×3Dプリンタ教室 東京・湯島 | 3DLab",
    description: "東京都文京区湯島のAI×3Dプリンタ教室。自由創作クラスをご用意。有料版AIが使い放題、ワークショップ30％OFFなど特典多数。",
