  ...
  },
  {
    ...
    value: (
      <>
        ...
        スクール：入会手続き完了後、各回の開講日に提供いたします。<br />
        商品の発送：ご注文から2週間以内に発送いたします。<br />
        デジタルデータ（クッキー型のSTLファイル等）：お支払い完了後、ただちにダウンロードいただけます。ダウンロード用のリンクはご購入時のメールアドレスへお送りし、発行から30日間・20回までご利用いただけます。
      </>
    ),
  },
  {
    ...
    value: (
      <>
        STL形式の3Dプリント用データです。ご利用には3Dプリンターと、一般的なスライサーソフト（PrusaSlicer、Cura、Bambu Studio 等）が必要です。<br />
        ノズル径0.4mm・積層ピッチ0.2mm での造形を想定しています。データそのものに動作保証はありません。
      </>
    ),
  },
  {
    ...
    value: (
      <>
        ...
        スクール会員の退会は、退会希望月の前月15日までにお申し出ください。<br />
        <br />
        <strong>デジタルデータについて</strong><br />
        クッキー型のSTLファイル等のデジタルデータは、その性質上、お支払い完了後の返品・返金をお受けできません。ご購入前に、サイト上の3Dプレビューで形状を必ずご確認ください。<br />
        データが破損している、ダウンロードできない等の不具合があった場合は、再送または全額返金いたします。<br />
        <br />
        <strong>お客様のデータをもとに製作する商品について</strong><br />
        アップロードいただいた画像から製作するクッキー型など、一点ずつのオーダーメイド品は、お支払い完了後のキャンセル・返品をお受けできません。<br />
        届いた商品に破損・不良があった場合、または注文内容と異なる場合は、商品到着後7日以内にご連絡ください。交換または全額返金いたします（返送料は当社負担）。
      </>
    ),
  },
]
