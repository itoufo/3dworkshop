            ...
            <div className="prose prose-gray max-w-none">
              ...
              <section className="mb-8">
                ...
                <ol className="list-decimal list-inside space-y-2 text-gray-700">
                  ...
                  <li>一度お支払いいただいた料金は、第5条（キャンセルポリシー）に定める場合、または当社の責めに帰すべき事由がある場合を除き、返金いたしません。</li>
                </ol>
              </section>
              ...
              <section className="mb-8">
                ...
                <ol className="list-decimal list-inside space-y-2 text-gray-700">
                  <li>開催日の前日までにお申し出いただいた場合は、無料でキャンセルでき、お支払い済みの料金を全額返金いたします（決済手数料も当社が負担します）。</li>
                  <li>開催日当日のキャンセル、および無連絡でのご不参加の場合は、返金いたしかねます。</li>
                  <li>前各項にかかわらず、当社の都合によりワークショップが中止となった場合は、全額を返金いたします。</li>
              ...
              <section className="mb-8">
                <h2 className="text-xl font-bold text-gray-900 mb-4">第8条の2（クッキー型メーカーおよび生成データ）</h2>
                <ol className="list-decimal list-inside space-y-2 text-gray-700">
                  <li>ユーザーは、クッキー型メーカーに画像をアップロードするにあたり、当該画像について必要な権利を有していること、または権利者の許諾を得ていることを保証するものとします。第三者のキャラクター、ロゴ、写真等を無断でアップロードしないでください。</li>
                  <li>当社は、アップロードされた画像および生成された形状データを、データの生成、ご注文の履行、不具合の調査のためにのみ利用します。ユーザーの許諾なく公開・第三者提供・宣伝への利用は行いません。</li>
                  <li>生成されたデータ（STLファイル）の著作権は当社に帰属しますが、ユーザーは購入後、私的利用および自身の事業における造形物の製作・販売のために、これを利用することができます。</li>
                  <li>前項にかかわらず、ユーザーは、データそのもの（STLファイルおよびそれを変換・改変したデータ）を第三者へ再配布、販売、共有、公開してはなりません。ダウンロード用のリンクを他者へ転送することも同様とします。</li>
                  <li>3Dプリントによる造形物は積層構造の性質上、表面の微細な隙間に汚れが残りやすく、当社は食品衛生上の安全性を保証しません。食品に用いる場合の衛生管理、および使用に伴う一切の結果については、ユーザーの責任において判断してください。</li>
                  <li>当社は、生成されたデータが特定の3Dプリンター、材料または造形設定において意図したとおりに造形されることを保証しません。</li>
                </ol>
              </section>
