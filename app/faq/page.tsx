...
const categories: Category[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'はい、可能です。「親子におすすめ！」と表示された親子向けの回では、付き添いのみの保護者1名は無料で、席数（定員）にもカウントしません。ご予約時の「参加人数」は制作されるお子さま2名でご入力ください。親子向け表示のない通常回では、付き添いの保護者も参加人数（1席分の料金）に含めてご予約ください。いずれもご家族での参加は大歓迎です。',
      },
      {
