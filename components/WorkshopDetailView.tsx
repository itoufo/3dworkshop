...
import { isOpenForRequest, getLatestPastSession, getNearestUpcomingSession } from '@/lib/workshops'
...
// ワークショップ詳細の本体。
// - /workshops/[id] (公開・ISR) と /workshops/preview/[id] (限定公開・動的) の両方から使う。
// - cookies() 等の Dynamic API はここでは呼ばない（ISR ルートで DYNAMIC_SERVER_USAGE になるため）。
export default function WorkshopDetailView({ workshop }: { workshop: Workshop }) {
